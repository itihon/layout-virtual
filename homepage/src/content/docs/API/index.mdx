...
const list = LayoutVirtual({ data, overscanHeight: 200, renderItem, scrollerClass: 'lv-scroller' });
...
<LayoutVirtual<Item> data={data} overscanHeight={200} renderItem={Article} scrollerClass="lv-scroller" />;
```
...
<template>
  <layout-virtual :data="data" :overscan-height="200" scroller-class="lv-scroller">
...
@Component({
  ...
  template: `
    <layout-virtual [data]="data" [overscanHeight]="200" scrollerClass="lv-scroller" >
